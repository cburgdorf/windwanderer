+++
title = "Rund um den Peloponnes: Von Messolonghi nach Githio"
date = 2026-07-14
...
[extra]
header_img = "/img/pelepones/porto_kagio.jpg"
+++


Nach unserer ersten Etappe von [Preveza nach Messolonghi](/saisonstart-in-preveza/) liegt nun der große Bogen um den Peloponnes vor uns. Über Killini und Katakolon arbeiten wir uns Stück für Stück nach Süden, kämpfen unterwegs erneut mit einem zickigen Autopiloten und entdecken dabei einige der schönsten Ecken, die uns Griechenland bisher gezeigt hat.
...
{{ imgpair(
  url_left="/img/pelepones/elvira_naeht.jpg",
  text_left="Elvira näht den Lederstreifen mit der Nähmaschine auf die Bimini.",
  url_right="/img/pelepones/bimini_streifen.jpg",
  text_right="Das fertige Ergebnis: Der Lederstreifen schützt die Bimini dort, wo der Baum hin und wieder darüber streift."
)}}
...
{{ imgpair(
  url_left="/img/pelepones/compass.jpg",
  text_left="Wir erneuern die Kontakte vom Kompass zum Autopiloten obwohl diese unkritisch aussehen.",
  url_right="/img/pelepones/schildkroete.jpg",
  text_right="Im Hafenbecken von Kyparissia ziehen einige große Schildkröten ihre Bahnen."
)}}
...
{{ imgpair(
  url_left="/img/pelepones/solarboot.jpg",
  text_left='Gesichtet in der "Piratenbucht" von Pylos. Ob das Ding auch noch segelt?',
  url_right="/img/pelepones/tv_upgrade.jpg",
  text_right="Per Zufall finden wir in Pylos Ersatz für unseren 24-Zoll-Android-TV, der uns in Preveza vor der Abreise leider nicht mehr rechtzeitig erreicht hatte."
)}}
...
{{ imgpair(
  url_left="/img/pelepones/pylos_ausgrabung.jpg",
  text_left="Museum von Pylos: In diesen Tonkrügen würden in der Antike Menschen begraben.",
  url_right="/img/pelepones/landschildkroeten.jpg",
...
{{ imgpair(
  url_left="/img/pelepones/steuermann_eric.jpg",
  text_left="Steuermann Eric macht die Hafeneinfahrt.",
  url_right="/img/pelepones/kalamata.jpg",
  text_right="Die alten Museumszüge sind das Highlight in Kalamata."
)}}
...
{{ imgpair(
  url_left="/img/pelepones/limeni.jpg",
  text_left="Limeni und die Ortschaften im Umkreis haben alle einen besonderen Steinhauscharme",
  url_right="/img/pelepones/gegrillter_kalmar.jpg",
  text_right="Christoph's Lieblingsessen der Saison: Frischer Kalmar vom Grill."
)}}
