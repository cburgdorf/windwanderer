+++
title = "Von Blitzen, Brüchen und Wiedersehen: Unser Saisonfinale in Griechenland"
date = 2026-01-19
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/pakete.jpg",
  text_left="Fast wie Weihnachten: Pakete aus Deutschland mit dem neuen Außenborder und anderen Dingen.",
  url_right="/img/saisonfinale-in-griechenland/schrauben.jpg",
  text_right="Schraube für Schraube dichten wir die Undichtigkeit am Geräteträger ab."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/ab_zerbrochen.jpg",
  text_left="Unschön: Der Außenborder hat beim Transport einen Bruch im Gehäuse erlitten.",
  url_right="/img/saisonfinale-in-griechenland/ab_wieder_ganz.jpg",
  text_right="Geschafft: Der Außenborder ist mit Glasfaser und Epoxidharz repariert."
)}}
...
Doch wir haben in den wenigen Tagen, bevor unsere Wanderer zurück ins Wasser kommen soll, noch weitere Arbeiten geplant. Allen voran steht die neue Toilette, die wir bereits vor Wochen beim Ship Chandler in der Cleopatra Marina geordert haben. Unsere elektrische Toilette macht hin und wieder Probleme und wir stehen vor der Wahl, ob wir sie warten oder komplett ersetzen sollen. Wir entscheiden uns schließlich für eine neue Johnson Silent Flush, bei der man das Ansaugen von Spülwasser und das Absaugen des Schmutzwassers separat steuern kann. Es gibt also drei Knöpfe: Einen der Ansaugen und Absaugen kombiniert (Normalfall) und einen Kipptaster, der in eine Richtung nur ansaugt und in die andere Richtung nur absaugt.
 Beim Einbau gibt es dann eine kleine Überraschung, denn keiner von uns hatte bedacht, dass diese erweiterte Funktionalität funktionsbedingt auch eine zweite Pumpe erfordert, die noch irgendwo im engen Unterschrank verbaut werden muss. Erschwerend kommt hinzu, dass sich Christoph in Deutschland sein Knie verletzt hat und nahezu alle Arbeiten, die eine gewisse körperliche Flexibilität erfordern, von Elvira erledigt werden müssen.

{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/toilette_schalter.jpg",
  text_left="Frauenpower: Elvira sägt sich durch 2 cm dickes Holz um den neuen Toilettenschalter zu montieren.",
  url_right="/img/saisonfinale-in-griechenland/toilette_fertig.jpg",
  text_right="Es ist vollbracht: Unsere neue Johnson Silent Flush Toilette ist eingebaut und funktioniert einwandfrei."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/messi_fischerboot.jpg",
  text_left="Ist das ein Messi-Fischerboot? Sieht zumindestens so aus. Gesehen im Fischerhafen von Molos auf Korfu.",
  url_right="/img/saisonfinale-in-griechenland/korfu_mit_freunden.jpg",
  text_right="Zusammen mit Silvan, Manuela und Elias erkunden wir Korfu Stadt."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/ankerprofi.jpg",
  text_left="Mit seinen 4 Jahren ist Eric schon ein echter Ankerprofi und steuert die elektrische Ankerwinsch ganz alleine.",
  url_right="/img/saisonfinale-in-griechenland/eric_geburtstag.jpg",
  text_right="Happy Birthday Eric! Zum 4. Geburtstag erwartet ihn eine geschmückte Wanderer, Geschenke und Kuchen"
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/muehle.jpg",
  text_left="Mühle in Korfu Stadt",
  url_right="/img/saisonfinale-in-griechenland/baustelle.jpg",
  text_right="Langwierige Arbeit: Die Verkleidung in der Bugkabine musste neu verklebt werden."
)}}

{{ imgwide(text="Erikoussa liegt ziemlich abseits der klassischen Touristenrouten. Doch ein paar Segelyachten ankern mit uns vor diesem kleinen Juwel nördlich von Korfu.", url="/img/saisonfinale-in-griechenland/erikoussa.jpg") }}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/vor_lakka.jpg",
  text_left="Die Bucht von Lakka auf Paxos ist überfüllt mit Yachten. Wir ankern etwas abseits.",
  url_right="/img/saisonfinale-in-griechenland/lakka.jpg",
  text_right="Das Straßenbild von Lakka ist geprägt von kleinen, liebevoll herausgeputzten Gassen mit Tavernen und Geschäften."
)}}
...
{{ imgwide(text="Ein echter Hingucker: Parga ist wirklich schön anzusehen.", url="/img/saisonfinale-in-griechenland/parga_weit.jpg") }}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/roller_griechisch.jpg",
  text_left="Frisch vom TÜV? Dieser Roller wird scheinbar von Stöckern zusammengehalten.",
  url_right="/img/saisonfinale-in-griechenland/thunfisch_kartoffeln.jpg",
  text_right="Aus dem Thunfisch schneiden wir Steaks, marinieren sie mit Zitronenschale, Salz und Pfeffer und reichen dazu Ofenkartoffeln."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/godewind_bank.jpg",
  text_left="Auf einer Wellenlänge: Mit Michel und Elvira von der Godewind verstehen wir uns prächtig.",
  url_right="/img/saisonfinale-in-griechenland/godewind_steakhouse.jpg",
  text_right="Außerdem haben die beiden zu jedem Ort in ganz Griechenland einen Restaurant-Tipp parat, hier im Steakhouse von Sivota."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/plataria.jpg",
  text_left="Bucht von Plataria: Ein ruhiger Ankerplatz auf dem Weg nach Igoumenitsa.",
  url_right="/img/saisonfinale-in-griechenland/debugging.jpg",
  text_right="Fehlersuche: Christoph geht dem Blitzschaden auf den Grund."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/ioannina_gruen.jpg",
  text_left="Hübsch bewachsenes Haus in der Altstadt von Ioannina.",
  url_right="/img/saisonfinale-in-griechenland/ioannina_alt.jpg",
  text_right="In der Altstadt von Ioannina befinden sich einige interessante Gebäude und Museen."
)}}

{{ imgwide(text="Unsere Wanderer vor Anker in Sagiada kurz vor der Grenze zu Albanien", url="/img/saisonfinale-in-griechenland/zuhause.jpg") }}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/lahjan_mit_fisch.jpg",
  text_left="Lahjan geht seine erste Brandbrasse an den Haken",
  url_right="/img/saisonfinale-in-griechenland/amsterdam.jpg",
  text_right="Könnte auch Amsterdam sein: Der Kanal zwischen der Altstadt und der Festung von Korfu Stadt lässt sich wunderbar mit dem Dinghi erkunden."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/ausritt.jpg",
  text_left="Ganz schön mutig: Lahjan und seine Oma besteigen die Pferde für einen Ausritt im Gelände.",
  url_right="/img/saisonfinale-in-griechenland/wrack.jpg",
  text_right="Dieses Wrack liegt in Ufernähe in der Bucht von Petriti und kann problemlos zu Fuß erreicht werden."
)}}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/crew.jpg",
  text_left="Familienfoto: Im Hintergrund die Festung von Korfu Stadt.",
  url_right="/img/saisonfinale-in-griechenland/kapitan.jpg",
  text_right="Kapitän Lahjan steuert das Dinghi wie ein Profi."
)}}
...
{{ imgwide(text="Blick über die Bucht von Sivota.", url="/img/saisonfinale-in-griechenland/sivota.jpg") }}
...
{{ imgwide(text="Wilde Kreuzerei: Starkwind aus der falschen Richtung beschert uns diesen Zickzack-Kurs.", url="/img/saisonfinale-in-griechenland/zickzack.jpg") }}
...
{{ imgpair(
  url_left="/img/saisonfinale-in-griechenland/regenzeug.jpg",
  text_left="Das erste mal in dieser Saison, dass wir unsere Regenkleidung brauchen.",
  url_right="/img/saisonfinale-in-griechenland/eric_mit_den_klammerhaenden.jpg",
  text_right="Eric mit den Klammerhänden. Am Ankunftstag in Preveza ist das Wetter wieder freundlicher."
)}}
...
{{ imgwide(text="Wir schicken unsere Wanderer in den wohl verdienten Winterschlaf.", url="/img/saisonfinale-in-griechenland/winterschlaf.jpg") }}
