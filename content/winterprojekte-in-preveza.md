...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/alter_ofen.jpg",
  text_left="Der alte Gasofen wird zerlegt, um die Einzelteile für die neue Konstruktion zu gewinnen.",
  url_right="/img/winterprojekte-in-preveza/ofen_fassung.jpg",
  text_right="Die neue Fassung für den elektrischen Ofen ist simpel, funktional und stabil. Die vorhandenen Klemmen für die Töpfe und Pfannen können weiterbenutzt werden."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/ofen_verbaut.jpg",
  text_left="Der neue Ofen an seinem Platz. Er kann sowohl schwingen als auch arretiert werden.",
  url_right="/img/winterprojekte-in-preveza/avocado_toast.jpg",
  text_right="Ein Testlauf mit Ofenbrot mit Avocado überzeugt."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/schleifen_christoph.jpg",
  text_left="Mit 80er Schleifpapier werden lose Schichten entfernt und die Oberfläche für die Grundierung vorbereitet.",
  url_right="/img/winterprojekte-in-preveza/schleifen_danny.jpg",
  text_right="Nach zwei Tagen in der Koje steigt Danny beim Schleifen wieder mit ein."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/neues_antifouling.jpg",
  text_left="Nach zwei Anstrichen mit der Primocon-Grundierung folgen zwei Anstriche mit dem knallroten Micron 350 Antifouling.",
  url_right="/img/winterprojekte-in-preveza/neue_kielfuge.jpg",
  text_right="Die alte Kielfuge wurde entfernt und fachgerecht erneuert."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/neue_anoden.jpg",
  text_left="Schafft und Propeller sind wieder blank und mit neuen Zinkanoden versehen.",
  url_right="/img/winterprojekte-in-preveza/kein_neuer_anstrich.jpg",
  text_right="Bei diesem Schiff lohnt sich wohl kein neuer Anstrich mehr!"
)}}
...
{{ imgwide(text="Über den Wasserfilter versorgen wir den Motor mit Kühlwasser damit er an Land laufen kann.", url="/img/winterprojekte-in-preveza/wasser_marsch.jpg")}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/wt_steckt_fest.jpg",
  text_left="Das Rohrbündel des Wärmetauschers steckt fest und lässt sich nicht bewegen.",
  url_right="/img/winterprojekte-in-preveza/wt_enge.jpg",
  text_right="Kein Platz: Für den Ein- und Ausbau benötigt man viel Geduld."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/wt_entfernt.jpg",
  text_left="Geschafft! Das Rohrbündel ist draußen und kann gereinigt werden.",
  url_right="/img/winterprojekte-in-preveza/wt_blank.jpg",
  text_right="Das Rohrbündel ist wieder sauber und bereit für den Wiedereinbau."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/brompton.jpg",
  text_left="Danny widmet sich Christophs Klapprad, das einen neuen Mantel benötigt.",
  url_right="/img/winterprojekte-in-preveza/winsch.jpg",
  text_right="Die E-Winsch wird gewartet und erhält neue Federn und Sperrklinken."
)}}
...
{{ imgpair(
  url_left="/img/winterprojekte-in-preveza/windex.jpg",
  text_left="Danny montiert den neuen Windex am Masttop.",
  url_right="/img/winterprojekte-in-preveza/kuh_auf_dem_schrottplatz.jpg",
  text_right="Griechische Realität: Diese Kühe leben scheinbar auf einem Schrottplatz."
)}}
