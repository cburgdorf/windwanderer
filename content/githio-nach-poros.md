...
In Githio heißt es zunächst einmal: warten. Wie [zuletzt berichtet](/pelepones/), haben wir über Kleinanzeigen einen gebrauchten Fluxgate-Kompass für unseren Autopiloten gekauft und einen netten Ladenbesitzer entlang unserer Route gefunden, der uns erlaubt, seinen Shop als Lieferadresse zu nutzen. Nun liegen wir also vor Githio und beobachten gespannt die Sendungsverfolgung, während unser alter Kompass weiterhin so tut, als wäre nie etwas gewesen.

{{ imgpair(
  url_left="/img/githio-nach-poros/kalmar.jpg",
  text_left="Christophs Dauerbrenner der Saison: Kalmar vom Grill.",
  url_right="/img/githio-nach-poros/picanha.jpg",
  text_right="Es muss nicht immer Griechisch sein. Brasilianisches Picanha vom Feinsten."
)}}
...
{{ imgpair(
  url_left="/img/githio-nach-poros/githio_coast_guard.jpg",
  text_left="Besuch in Githio: Die Coast Guard schaut bei uns vorbei und kontrolliert unsere Papiere.",
  url_right="/img/githio-nach-poros/githio_wc.jpg",
  text_right="Lange aufgeschoben: Der alte Fäkalienschlauch wird endlich ersetzt."
)}}

An einem anderen Tag machen wir eine Radtour zum Strand von Valtaki, wo seit über 40 Jahren das [Wrack der Dimitrios](https://maps.app.goo.gl/ApVQ14Stf891EgEw7) vor sich hin rostet. Der Weg dorthin führt mit einigen Steigungen entlang einer stark befahrenen Landstraße, auf der Eric auf seinem kleinen Rad ganz schön zu kämpfen hat. Doch er beißt sich tapfer durch und der Ausflug lohnt sich: Das riesige, rostige Schiff, das halb im Sand liegt, ist ein wirklich beeindruckender Anblick. Eric und Elvira finden sogar einen Einstieg und inspizieren das Wrack von innen.

{{ imgpair(
  url_left="/img/githio-nach-poros/githio_shipwreck.jpg",
  text_left="Das Wrack der Dimitrios liegt seit den 80er Jahren am Strand von Valtaki bei Githio.",
  url_right="/img/githio-nach-poros/githio_shipwreck_2.jpg",
  text_right="Vorsichtig wagen sich Elvira und Eric in das Innere des rostigen Wracks."
)}}

{{ imgpair(
  url_left="/img/githio-nach-poros/githio_empanadas.jpg",
  text_left="Bordküche international: Christoph macht Empanadas.",
  url_right="/img/githio-nach-poros/githio_octopus.jpg",
  text_right="Typisches Straßenbild in Githio. Frischer Oktopus hängt in der Sonne zum Trocknen."
)}}
...
{{ imgwide(text="Karibik? Nein, Elafonisos! Die Strände hier müssen den Vergleich nicht scheuen.", url="/img/githio-nach-poros/elafonisos1.jpg") }}

{{ imgpair(
  url_left="/img/githio-nach-poros/spinne.jpg",
  text_left="Rote Röhrenspinne auf Elafonisos. Sieht gefährlich aus, ist aber harmlos.",
  url_right="/img/githio-nach-poros/kompass.jpg",
  text_right="Der neue (gebrauchte) Fluxgate-Kompass findet seinen Platz unter den Bodenbrettern vor dem Niedergang."
)}}
...
Der Name leitet sich vom griechischen „moni emvasia“ ab, was so viel wie „einziger Zugang“ bedeutet, denn die mittelalterliche Stadt ist tatsächlich nur über einen einzigen schmalen Weg zu erreichen. Von der Landseite ist sie praktisch unsichtbar, erst wer den Felsen umrundet, entdeckt die alte Stadt, die sich an die Südostflanke schmiegt. Nicht umsonst wird [Monemvasia](https://de.wikipedia.org/wiki/Monemvasia) auch als das Gibraltar des Ostens bezeichnet. Im Mittelalter war die Festungsstadt ein bedeutender Handelsplatz der Byzantiner und gab ganz nebenbei dem Malvasia-Wein seinen Namen.

{{ imgpair(
  url_left="/img/githio-nach-poros/monemvasia_anfahrt.jpg",
  text_left="",
  url_right="/img/githio-nach-poros/monemvasia_ankerplatz.jpg",
  text_right=""
)}}

{{ imgwide(text="", url="/img/githio-nach-poros/monemvasia_panorama.jpg") }}

{{ imgpair(
  url_left="/img/githio-nach-poros/monemvasia_kanone.jpg",
  text_left="",
  url_right="/img/githio-nach-poros/monemvasia_stadt.jpg",
  text_right=""
)}}
...
{{ imgwide(text="Links im Bild: Unsere Wanderer liegt mit Landleinen im engen Fjord.", url="/img/githio-nach-poros/fjord.jpg") }}
{{ imgpair(
  url_left="/img/githio-nach-poros/eric_angelt.jpg",
  text_left="Eric probiert sein Glück an der Handangel.",
  url_right="/img/githio-nach-poros/eric_gottesanbeterin.jpg",
  text_right="Eine Gottesanbeterin macht es sich auf Eric gemütlich."
)}}
...
{{ imgpair(
  url_left="/img/githio-nach-poros/paralia.jpg",
  text_left="In Paralia gehen wir längsseits. Ein kleiner, aber sehr hübscher Ort.",
  url_right="/img/githio-nach-poros/dinghy.jpg",
  text_right="Nicht so einfach, wie es aussieht. Das Aufkleben der neuen Öse gestaltet sich schwieriger als gedacht."
)}}
...
Wir segeln weiter nach Vivari, wo uns ein besonderes Highlight erwartet: Steffi und Clemens, die wir [erst kürzlich in Petalidi und Kalamata getroffen haben](/pelepones/), kommen für zwei Tage zum Segeln an Bord.
...
{{ imgpair(
  url_left="/img/githio-nach-poros/steffi_und_clemens.jpg",
  text_left="Für zwei Tage haben wir Steffi und Clemens als Gäste an Bord.",
  url_right="/img/githio-nach-poros/nafplio.jpg",
  text_right="Blick über die Dächer von Nafplio."
)}}
...
{{ imgpair(
  url_left="/img/githio-nach-poros/stutzen.jpg",
  text_left="Der Diesel leckt am Einfüllstutzen.",
  url_right="/img/githio-nach-poros/seeigel.jpg",
  text_right="Obacht beim Badespaß. Es wimmelt von Seeigeln."
)}}
...
Wir nehmen es sportlich und kreuzen im Starkwind die kurze Strecke bis nach Tolo, wo wir eine Nacht vor Anker bleiben. Am nächsten Tag motoren wir bei Flaute das kurze Stück bis Kilada. Der Ort selbst ist, freundlich formuliert, überschaubar. Ehrlich formuliert: Es ist tote Hose. Die gut geschützte Bucht und das gut geführte Trockendock [Basimakopoulos](https://www.noforeignland.com/map/place/5342179388030976) locken dennoch zahlreiche Schiffe hierher.

Ganz zufällig treffen wir Marvin und Liz von den [Sailing Climbers](https://www.youtube.com/@sailingclimbers) im örtlichen Supermarkt und tauschen uns aus.

{{ imgpair(
  url_left="/img/githio-nach-poros/cave1.jpg",
  text_left="Wir verewigen uns im Gästebuch der Höhle.",
  url_right="/img/githio-nach-poros/cave2.jpg",
  text_right="Die Höhlen waren bereits in prähistorischer Zeit bewohnt."
)}}
...
{{ imgpair(
  url_left="/img/githio-nach-poros/hydra_kultur.jpg",
  text_left="Im Museum von Hydra holen wir uns unsere Portion Kultur und bestaunen die schönen Exponate.",
  url_right="/img/githio-nach-poros/hydra_hafen.jpg",
  text_right="Der Hafen von Hydra ist klein und wuselig. Wir sind aus gutem Grund mit der Fähre aus Ermioni angereist."
)}}
